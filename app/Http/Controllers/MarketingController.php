...
class MarketingController extends Controller
{
    public function home(): View
    {
        ...
        $payload = [
            ...
            'frontDoor' => $this->modulePrice((array) config('marketing.modules.front_door', []), 3000, 1000),
            'prescription' => $this->modulePrice((array) config('marketing.modules.prescription', []), 2500, 250),
            'liveQueue' => $this->modulePrice((array) config('marketing.modules.live_queue', []), 12000, 2000),
            'bundle' => $this->modulePrice((array) config('marketing.modules.bundle_all', []), 15000, 3000),

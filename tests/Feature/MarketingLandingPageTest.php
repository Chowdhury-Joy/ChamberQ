...
class MarketingLandingPageTest extends TestCase
{
    public function test_central_root_shows_solo_focused_sales_landing(): void
    {
        ...
        $response->assertSee('Keep your chamber', escape: false);
        $response->assertSee('in order.', escape: false);
        $response->assertSee('Made for independent doctors', escape: false);
        $response->assertSee('For your chamber practice', escape: false);
        $response->assertDontSee('Give patients their', escape: false);
        $response->assertDontSee('I need a doctor', escape: false);
        ...
        $response->assertSee('Your name gets recommended', escape: false);
        ...
        $response->assertSee('Bebas+Neue', escape: false);
        $response->assertDontSee('Instrument+Serif', escape: false);
        $response->assertDontSee('DM+Sans', escape: false);

...
class StaffDeskBanglaTest extends TestCase
{
    private const DESK_FILES = [
        ...
        'app/Filament/TenantAdmin/Support/ReferringDoctorPicker.php',
        ...
        'app/Filament/TenantAdmin/Pages/FollowUpReminders.php',
        'resources/views/filament/tenant-admin/slot-block-notify.blade.php',

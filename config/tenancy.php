...
return [
     ...
     */
    'bootstrappers' => [
        // Prefixes keys on file/database cache; uses Stancl tags only when the
        // store supports them. The stock CacheTenancyBootstrapper always tags,
        // which crashes CACHE_STORE=database/file.

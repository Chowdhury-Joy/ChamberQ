<section class="mk-section" id="faq" aria-labelledby="faq-heading">
    <div class="mk-wrap mk-faq-layout">
        ...
        <div class="mk-faq">
            ...
            <details>
                <summary>What about walk-ins?</summary>
                <p>Walk-ins stay welcome. Online serials fill the session first; remaining seats can take walk-ins as usual.</p>
            </details>
            <details>
                <summary>Who sets it up?</summary>
                <p>We set up your chamber page, sessions, and branding with you over WhatsApp. You don’t need to be technical.</p>
            </details>
            <details>
                <summary>Can my chamber site be Bangla?</summary>
                <p>Yes — you can enable Bangla on your chamber site. The sales chat with us can be in Bangla too.</p>
            </details>
            <details>
                <summary>Can I send SMS confirmations?</summary>
